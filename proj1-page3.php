...
<div class="btn-group btn-lg" role="group" aria-label="">
  ...
  <a href="proj1-page2.php"><button type="button" class="btn btn-danger" style="padding-left:30px; padding-right:30px; background-color:#ff4d4d">Place Order</button></a>
</div>
