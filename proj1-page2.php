...
<div class="btn-group btn-lg" role="group" aria-label="">
  ...
  <a href="proj1-page3.php"><button type="button" class="btn btn-success btn-success-outline" style="padding-left:20px; padding-right:20px;background-color:#70db70">Exquisite Products</button></a>
</div>
